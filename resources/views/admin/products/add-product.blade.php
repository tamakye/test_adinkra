                        ...
                        <div class="card p-4  mb-2">
                            ...
                            <div class="row mb-0">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="poetry_in_jewelry" class="form-control @error('poetry_in_jewelry') is-invalid @enderror" maxlength="150" id="poetry_in_jewelry">{{ old('poetry_in_jewelry') }}</textarea>
