...
@section('title', 'Edit Distributor | Dashboard')
...
<div class="content">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-2 mb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input" id="password"  name="password">
                                          <label class="custom-control-label" for="password">Reset password</label>
                                          <small>This will reset the password to the  email address as <em> {{ $distributor->email }} </em>.</small>
                                      </div>
    ...
    <div class="row">
        <div class="col-md-12 mt-4 mt-md-0">
            <div class="card" id="company-details">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.distributors.profile', $distributor->slug) }}" method="post">
                        @csrf
        ...
        <div class="form-group d-flex">
            <button class="btn btn-primary ml-auto ">update details</button>
        </div>
    </form>
</div>
</div>
