...
@section('materials_active','active')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class=" col-md-4">
                 <div class="card">
                    <div class="card-body">
                        <form action="{{ route('materials') }}"  method="post" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   {{--  <td>
                                        <img width="80" src="{{ asset(get_material_thumbnail($material->thumbnail))}} " alt="{{ $material->name }} thumbnail">
                                    </td> --}}
                                    <td>{{ $loop->index + 2 }}</td>
                                    <td>
                                        <a href="{{ route('edit-materials', $material->slug) }}">{{ $material->name }}</a>
                                    </td>
                                    <td>{{ $material->slug }}</td>
