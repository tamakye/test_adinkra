...
@section('collections_active','active')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class=" col-md-4">
                 <div class="card">
                    <div class="card-body">
                        <form action="{{ route('collections') }}"  method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-outline-primary">Add new make</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-hover display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img width="80" src="{{ asset(get_collection_thumbnail($collection->thumbnail))}} " alt="{{ $collection->name }} thumbnail">
                                    </td>
                                    <td>
                                        <a href="{{ route('edit-collections', $collection->slug) }}">{{ $collection->name }}</a>
                                    </td>
