...
<div class="container carousel-wrapper mt-0">
	<div id="landinCarousel" class="carousel slide" data-bs-ride="carousel">
		...
		<button class="carousel-control-prev" type="button" data-bs-target="#landinCarousel" data-bs-slide="prev">
			<span class="carousel-control-prev-icon" aria-hidden="true"></span>
			<span class="visually-hidden">Previous</span>
		</button>
		<button class="carousel-control-next" type="button" data-bs-target="#landinCarousel" data-bs-slide="next">
...
<section class="collection-1">
	<div class="container">
		<div class="heading-text d-flex flex-column text-center position-relative">
			...
			<p class="sub-title w-55 m-auto">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>
		</div>
	</div>      
</section>
								...
								<div class="row position-relative h-100">
									...
									<div class="col-md-6 d-flex justify-content-center flex-column text-center h-100">
										...
										<div class="text-overlay m-auto">
											<h3 class="title mb-4 mt-8">STONE OF AGES</h3>
											<p class="sub-title  ps-4 pe-4 m-auto mb-1">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 pt-6 pe-5 col-left">
				...
				<div class="text-end">
					<p class="sub-title w-50 text-gray  float-end ">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>
				</div>
...
<section class="p-100 art">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6 text-center">
				<h5 class="title text-gray">ART AND SCULPTURE COLLECTION</h5>
				<p class="text-gray sub-title">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>
			</div>
		</div>
						...
						<div class="content-body h-100 mb-5">
							<div class="row position-relative h-100">
								<div class="col-md-6 d-flex justify-content-center flex-column text-center h-100">
									...
									<div class="text-overlay m-auto">
										<h3 class="title mb-4 mt-6">STONE OF AGES</h3>
										<p class="sub-title  ps-4 pe-4 m-auto mb-1">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>
...
<section class="p-100 custom-jewlry">
	<div class="container h-100">
			...
			<div class="col-md-6 h-100">
				<div class=" d-flex flex-column text-center h-100">
					<span class=" m-auto">
						...
						<p class="text-white mb-5 sweetsand-regular">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>

						<a href="{{ route('products.listing', 'custom-jewelry') }}" class="text-uppercase btn btn-create sweetsand-bold">Create now</a>
					</span>
				</div>
			</div>
			<div class="col-md-3 position-relative">
...
<section class="collection p-100">
	<div class="container h-100">
		<div class="row justify-content-center" style="margin-bottom: 10rem!important;">
			<div class="col-md-6 text-center">
				...
				<p class="text-gray sweetsand-regular">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I.</p>
			</div>
		</div>
